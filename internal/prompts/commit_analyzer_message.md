...
- Messages must be written in the past tense using first person singular with implicit subject ("eu").
- Do not explicitly include the pronoun "eu"; the subject must remain implicit.
- Example verb style: "Implementei", "Criei", "Ajustei", "Refatorei".
...
- Do not translate technical terms, programming keywords, library names, framework names, API names, commit hashes, code identifiers, or English terminology commonly used in software development.
